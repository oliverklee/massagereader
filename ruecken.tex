...
Ihr streicht dabei mit beiden Handflächen \fett{von der Wirbelsäule quer nach außen}. Die Finger zeigen dabei nach außen, und der Druck kommt vor allem von den Handballen. Arbeitet euch so ihn Bahnen von der Hüfte bis zum Kopf hoch.
...
Ihr zieht \fett{mit je einer Hand pro Seite} nach oben.
...
Hier massiert ihr \fett{mit beiden Händen auf einer Seite}. Die Route ist dieselbe wie mit zwei Händen.
...
Ihr knetet den Gesäßmuskel der gegenüberliegenden Seite \fett{mit beiden Händen auf einer Seite}.


\subsubsection{Punktuelle Druckmassage}

Diese Technik bedarf einiger Übung, bis das mit dem Abtasten klappt.

\fett{Tastet den Rücken ab} und findet die Stellen heraus, an denen noch Verspannungen sitzen. Drückt dort jetzt \fett{mit zwei Mittelfingern übereinander} oder zwei Daumen übereinander langsam \fett{fest ein, zwei Atemzüge lang hinein}. Macht danach mit der nächsten Stelle weiter.
...
\begin{description}
  ...
  \item [Fingernagel-Streichungen nach oben:] Streicht mit glatten Tigerkrallen \fett{entgegen der Kratzrichtung} nach oben. Beide Hände bewegen sich dabei parallel. Macht dabei mehrere Bahnen, sodass ihr die komplette Rückenfläche abdeckt.
