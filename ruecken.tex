...
\begin{oframed}
  ...
  \begin{enumerate}
    ...
    \item \fett{Endlos-Streichungen auf dem Rückenstrecker mit den Fingerknöcheln:} Formt Tigerkrallen mit euren Händen. Streicht dann mit dem zweiten Knöchel der Finger den Rückenstrecker der \fett{gegenüberliegenden Rückenhälfte} mit beiden Händen von der Hüfte bis zum Kopf aus. Stützt bei Bedarf euren Zeigefinger mit dem Daumen.
  \end{enumerate}
\end{oframed}
\pagebreak
