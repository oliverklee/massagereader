...
Gebt \fett{Öl in eine Hand} und verreibt das Öl dann in beiden Händen. Haltet dabei mit einer Hand den Kontakt zu eurer Partnerin. \fett{Verteilt das Öl} mit großen Kreisen auf dem Rücken.
...
\begin{enumerate}
	\item \fett{Hände parallel:} Handflächen parallel links und rechts neben die Wirbelsäule legen mit den Fingen in Richtung Kopf
...
\begin{enumerate}
	...
	\item \fett{Parmaschinken rollen:} quer über den Rücken von euch in Richtung der gegenüberliegenden Rückenseite
\end{enumerate}


\subsection{Schräg vom Kopfende}
\fett{Kreuzbein nach unten dehnen:} Schiebt mit den beiden übereinandergelegten Handballen das Kreuzbein eurer Partnerin in Richtung der Füße und haltet den Druck ein paar Sekunden.
...
\begin{enumerate}
	\item \fett{Parmaschinken rollen:} in mehreren Bahnen vom Becken in Richtung Kopf
...
\begin{enumerate}
	\item \fett{Krallen:} Greift die Muskeln mit euren Tigerkrallen.
	\item \fett{Unter dem Schulterblatt:} Hebt das Schulterblatt und den Ellenbogen eurer Partnerin an und stützt diese mit einem Arm (und bei Bedarf mit eurem Knie). Massiert dann mit der Daumenspitze mit viel Druck unter dem Schulterblatt entlang.
	\item \fett{Schulterblatt pressen:} Bitte eurer Partnerin, tief einzuatmen. Wenn eure Partnerin ausatmet, drück mit beiden Händen das Schulterblatt in Richtung Unterlage.
