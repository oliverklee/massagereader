...
\begin{description}
  \item[Namensnennung.] Ihr müsst den Namen des Autors (Oliver Klee) nennen. Wenn ihr dabei zusätzlich auch noch die Quelle\footnote{\url{https://github.com/oliverklee/massagereader}} nennt, wäre das nett. Und wenn ihr mir zusätzlich eine Freude machen möchtet, sagt mir per E-Mail Bescheid.
...
Die ausführliche Version dieser Lizenz findet ihr online.\footnote{\url{https://creativecommons.org/licenses/by-sa/3.0/de/}}
